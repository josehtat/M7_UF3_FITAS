...
<body>
    <form method="post">
        <label for="numMin">Introdueix el nombre minim de habitants de ciutats que vols mostrar:</label>
        <input type="number" name="numMin" id="numMin">
        <br>
        <label for="numMax">Introdueix el nombre maxim de habitants de ciutats que vols mostrar: </label>
    ...
    $consulta = "SELECT * FROM city where population between $numMin and $numMax order by population asc;";
